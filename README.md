...
This repository documents the setup process requested during the application process.
...
## Steps Completed 
    ...
    2. Open Cursor Marketplace
    3. Searched for Claude Code extension
    4. Searched for Codex extension
    5. Created a public GitHub repository
    6. Connected repository with Cursor
    7. Edited and updated README.md
    8. Prepared repository for commit and push

## Issues Encountered
- Unable to find Claude Code extension in Cursor Marketplace
- Unable to find Codex extension in Cursor Marketplace
- Initial confusion navigating Cursor interface and GitHub workflow
